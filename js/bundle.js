...
function cards() {
    ...
    class MenuCard {
        constructor(src, alt, title, descr, price, parentSelector, ... classes) {
            ...
            this.transfer = 27;
            this.changeToUAH(); // автоматически вызовится при инициализации конструктора
        }
...
function forms(formSelector, modalTimerId) {
    ...
    function bindPostData(form) {
        form.addEventListener('submit', (e) => {
            ...
            const formData = new FormData(form);// помогает быстро собрать и сформировать данные, которыми пользователь заполнил форму (ключ (атрибут name у тека(input, textarea и т.д.)): значение (которое ввел пользователь)).
